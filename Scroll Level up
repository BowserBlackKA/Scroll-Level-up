/**
 *Submitted for verification at sepolia.scrollscan.com on 2024-10-14
*/
...
// BRYANMASK ERC20 Token Contract
contract BRYANMASK is ERC20 {
 
    // Constructor that mints the initial supply to the deployer's address
    constructor(uint256 initialSupply) ERC20("BRYANMASK","BMK") {
